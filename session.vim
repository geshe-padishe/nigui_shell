...
inoremap <F6> if (!( = ()malloc(sizeof() * )))return ();<Up><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left>
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-gitgutter,~/.vim/plugged/editorconfig-vim,~/.vim/plugged/lightline.vim,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/emmet-vim,~/.vim/plugged/vim-multiple-cursors,~/.vim/plugged/vim-eunuch,~/.vim/plugged/ale,~/.vim/plugged/vim-startify,~/.vim/plugged/vim-surround,~/.vim/plugged/syntastic,~/.vim/plugged/vim-42header,~/.vim/plugged/vim-sublime-monokai,~/.vim/plugged/awesome-vim-colorschemes,~/.vim/plugged/sonokai,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-devicons,~/.vim/plugged/nerdtree-buffer-ops,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,~/.vim/bundles/repos/github.com/Shougo/dein.vim,~/.vim/bundles/.cache/.vimrc/.dein,/usr/share/vim/vim81,~/.vim/bundles/.cache/.vimrc/.dein/after,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/plugged/vim-42header/after,~/.vim/plugged/awesome-vim-colorschemes/after,~/.vim/after,~/.vim/bundles/repos/github.com/Shougo/dein.vim
set scrolloff=5
set shiftwidth=4
...
exe 'vert 5resize ' . ((&columns * 94 + 141) / 282)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("ft_mems.c") | buffer ft_mems.c | else | edit ft_mems.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
wincmd w
argglobal
if bufexists("ft_prompt.c") | buffer ft_prompt.c | else | edit ft_prompt.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
37
normal! zc
let s:l = 68 - ((61 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
wincmd w
argglobal
if bufexists("dynarray.c") | buffer dynarray.c | else | edit dynarray.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
61
normal! zc
let s:l = 85 - ((64 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
...
wincmd w
argglobal
if bufexists("ft_print.c") | buffer ft_print.c | else | edit ft_print.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 24 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
